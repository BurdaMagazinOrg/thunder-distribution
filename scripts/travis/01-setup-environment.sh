...
if [[ $TRAVIS_PHP_VERSION = '5.6' ]] ; then
  ...
  #PHP_YAML_VERSION_FROM_API=`curl -L -s -H 'Accept: application/json' https://api.github.com/repos/php/pecl-file_formats-yaml/tags | jq -r '[ .[].name | select(index("1.")==0) ] | .[0]'`
else
