...
COMPOSER_MEMORY_LIMIT=-1 composer require "burdamagazinorg/thunder:*" "mglaman/phpstan-drupal" "phpstan/phpstan:0.11.6"  "nette/di:*@stable" "phpstan/phpstan-deprecation-rules" --no-progress
