...
COMPOSER_MEMORY_LIMIT=-1 composer require "burdamagazinorg/thunder:*" "thunder/thunder_testing_demo" "mglaman/phpstan-drupal" "phpstan/phpstan-deprecation-rules" --no-progress
