...
COMPOSER_MEMORY_LIMIT=-1 composer require "burdamagazinorg/thunder:*" "thunder/thunder_testing_demo:dev-task/2.x-content" "mglaman/phpstan-drupal" "phpstan/phpstan-deprecation-rules" --no-progress
