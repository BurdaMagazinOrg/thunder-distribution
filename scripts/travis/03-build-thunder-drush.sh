...
composer require "thunder/thunder_testing_demo:2.x-dev" "behat/mink-selenium2-driver" "behat/mink-goutte-driver" "mikey179/vfsStream" "lullabot/amp" "pusher/pusher-php-server:^3.0.0" "facebook/facebook-instant-articles-sdk-php:^1.10.0" --no-progress --working-dir ${TEST_DIR}/docroot
