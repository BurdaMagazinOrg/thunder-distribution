...
if [[ ${TEST_UPDATE} != "true" ]]; then
    thunderDumpFile=thunder.php paratest --phpunit=/home/travis/build/BurdaMagazinOrg/thunder-distribution/../test-dir/bin/phpunit ${THUNDER_DIST_DIR}/tests --verbose --color --group ThunderConfig
fi

# execute Drupal tests
thunderDumpFile=thunder.php paratest --phpunit=/home/travis/build/BurdaMagazinOrg/thunder-distribution/../test-dir/bin/phpunit ${THUNDER_DIST_DIR}/tests --verbose --color --group Thunder,thunder_updater
