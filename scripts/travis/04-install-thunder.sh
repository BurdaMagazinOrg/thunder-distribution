...
drush_make_thunder() {
    ...
    git clone --depth 1 --single-branch --branch "feature/content_moderation" https://github.com/BurdaMagazinOrg/theme-thunder-admin.git ${TEST_DIR}/docroot/profiles/thunder/themes/thunder_admin
