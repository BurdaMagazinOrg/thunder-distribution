...
DISTRIBUTION_REPOSITORY_SYNC_KEY=${DISTRIBUTION_REPOSITORY//\//-}
DISTRIBUTION_REPOSITORY_SYNC_KEY=${DISTRIBUTION_REPOSITORY_SYNC_KEY/-/}
...
THUNDER_DIRECTORY_SYNC_KEY=${THUNDER_DIRECTORY//\//-}
THUNDER_DIRECTORY_SYNC_KEY=${THUNDER_DIRECTORY_SYNC_KEY/-/}
...
sed -e "s|THUNDER_DIRECTORY|${THUNDER_DIRECTORY}|g" -e "s|DISTRIBUTION_REPOSITORY|${DISTRIBUTION_REPOSITORY}|g" -e "s|THUNDER_SYNC_DIRECTORY|${THUNDER_DIRECTORY_SYNC_KEY}|g" -e "s|DISTRIBUTION_SYNC_REPOSITORY|${DISTRIBUTION_REPOSITORY_SYNC_KEY}|g" ${DISTRIBUTION_REPOSITORY}/scripts/development/docker-sync-template.yml > ${THUNDER_DIRECTORY}/docker-sync.yml
