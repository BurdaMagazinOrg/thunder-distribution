...
Version 2.0 ads new functionality and improved updating to thunder. We bumbed the major version to 2 because there are 
...
to your repositories section in your composer.json  and the installer-path section of the same file should look like this:
