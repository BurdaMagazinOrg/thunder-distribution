  ...
  'Create an article with paragraphs': function (browser) {
    browser
      ...
      .paragraphsAdd('field_paragraphs', 'text', 1, {
        text: '<p><strong><span>1: Lorem ipsum dolor sit amet</span></strong></p><p><span>an est tacimates molestiae, vel eu animal suscipit. Populo accusam ad has, cu libris disputando voluptatibus ius, feugiat nusquam instructior id pro?</span></p><p><span>Vel possim invidunt ex, est facer erant phaedrum ea? Ei ancillae detraxit mei, antiopam euripidis vim in? Vel ea amet movet fastidii. Magna oratio molestie eum ea, ius cu odio cibo?</span></p>'
      })
      .paragraphsAdd('field_paragraphs', 'image', 2, {
        selectIndex: 13
      })
      .paragraphsAdd('field_paragraphs', 'instagram', 3, {
        url: 'https://www.instagram.com/p/BtlH0ysgGLs/?utm_source=ig_web_copy_link'
      })

      .performanceMark('create paragraphs - set 2')
      .paragraphsAdd('field_paragraphs', 'text', 4, {
        text: '<p><strong><span>2: Ex cotidieque intellegebat nec</span></strong></p><p><span>quo cu quis ridens, ei  cibo omnes complectitur duo. Cu sed deleniti indoctum assueverit. Elit eligendi senserit eu nam. Velit delectus ut cum, no vim habeo veniam mentitum, eos id eros senserit.</span></p>'
      })
      .paragraphsAdd('field_paragraphs', 'image', 5, {
        selectIndex: 14
      })
      .paragraphsAdd('field_paragraphs', 'instagram', 6, {
        url: 'https://www.instagram.com/p/BtSRBAgAYod/?utm_source=ig_web_copy_link'
      })

      .performanceMark('create paragraphs - set 3')
      .paragraphsAdd('field_paragraphs', 'text', 7, {
        text: '<p><strong><span>3: Ne cum copiosae praesent, feugait quaestio inciderint eos ad.</span></strong></p><p><span>Odio salutatus constituto eam ea. Mel zril cotidieque dissentiunt ea, erant inimicus convenire sit cu, ea nam oratio vituperatoribus. Noster invenire instructior ex pro. Duo ad mutat fierent.</span></p>'
      })
      .paragraphsAdd('field_paragraphs', 'image', 8, {
        selectIndex: 12
      })
      .paragraphsAdd('field_paragraphs', 'instagram', 9, {
        url: 'https://www.instagram.com/p/BtH8DB3g3GL/?utm_source=ig_web_copy_link'
      })

      .performanceMark('create paragraphs - set 4')
      .paragraphsAdd('field_paragraphs', 'text', 10, {
        text: '<p><strong><span>4: Commune accumsan deleniti ad duo, cum cibo lorem delicatissimi ex!</span></strong></p><p><span>Cum mundi nostro forensibus id. At eos elitr fabulas intellegebat! Eleifend praesent mea no, id stet deseruisse pro!</span></p>'
      })
      .paragraphsAdd('field_paragraphs', 'image', 11, {
        selectIndex: 13
      })
      .paragraphsAdd('field_paragraphs', 'instagram', 12, {
        url: 'https://www.instagram.com/p/Btv_rtKF8mU/?utm_source=ig_web_copy_link'
      })

      .performanceMark('create paragraphs - set 5')
      .paragraphsAdd('field_paragraphs', 'text', 13, {
        text: '<p><strong><span>5: Ex persecuti argumentum pri, phaedrum cotidieque mel te?</span></strong></p><p><span>Vix choro nusquam molestiae eu. Pro ei prodesset honestatis, an duo omnes dictas meliore. Fastidii reformidans sea ne. Modus mucius per et, audiam partiendo eu sea! Eam ea augue signiferumque.</span></p>'
      })
