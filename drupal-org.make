...
projects[select2][download][url] = http://git.drupal.org/project/select2.git
projects[select2][download][branch] = 8.x-1.x
...
libraries[select2][download][url] = https://github.com/select2/select2/archive/4.0.5.zip
